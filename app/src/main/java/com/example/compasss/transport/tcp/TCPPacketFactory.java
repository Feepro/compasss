...
package com.example.compasss.transport.tcp;
...
import com.example.compasss.Packet;
import com.example.compasss.transport.ITransportHeader;
...
public class TCPPacketFactory {
	private final String TAG = "TCPPacketFactory";
	...
	public static Packet createSynAckPacketData(IPv4Header ip, TCPHeader tcp){
		...
		tcpheader.setSequenceNumber(seqNumber);
		Log.d(TCPPacketFactory.class.getName(),"Set Initial Sequence number: "+seqNumber);
		...
		return new Packet(ipheader, (ITransportHeader) tcpheader, createPacketData(ipheader, tcpheader, null));
		//maybe error
	}
